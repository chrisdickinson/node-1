...
const Module = binding.ContextifyModule;
...
const realEvaluate = Module.prototype.evaluate;

Module.prototype.evaluate = function () {
  if (this.evaluated) {
    return this.namespace;
  }
  this.evaluated = true;
  this.namespace = realEvaluate.call(this);
  return this.namespace;
}
